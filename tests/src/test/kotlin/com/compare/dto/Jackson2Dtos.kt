...
data class SmallObjectJackson2(
...
@JsonInclude(JsonInclude.Include.NON_NULL)
data class LargeObjectJackson2(
    ...
    @param:JsonProperty("nested") val nested: NestedObjectJackson2 = NestedObjectJackson2(),
    ...
    @param:JsonProperty("nestedList") val nestedList: List<NestedObjectJackson2> = listOf(NestedObjectJackson2(), NestedObjectJackson2(id = 2, value = "second"))
)

data class NestedObjectJackson2(
