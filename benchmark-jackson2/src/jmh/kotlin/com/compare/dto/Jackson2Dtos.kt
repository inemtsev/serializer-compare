...
data class LargeObjectJackson(
    ...
    @param:JsonProperty("nested") val nested: NestedObjectJackson = NestedObjectJackson(),
    ...
    @param:JsonProperty("nestedList") val nestedList: List<NestedObjectJackson> = listOf(NestedObjectJackson(), NestedObjectJackson(id = 2, value = "second"))
)

data class NestedObjectJackson(
